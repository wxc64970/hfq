            ...
            Expanded(
              ...
              children: [
                Container(
                  ...
                  height: kSize64,
                  decoration: BoxDecoration(color: Color(0x1A00C427), borderRadius: BorderRadius.circular(kSize16)),
                  child: Row(
                    children: [
                      const Icon(
                        Icons.check_circle,
                      ...
                      Text(
                        "您的额度初审已通过",
                        style: TextStyle(fontSize: kFontSize24, color: const Color(0xFF00C427)),
                      )
                    ],
                  ),
                ),
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          Text(
                            "¥",
                            style: TextStyle(fontSize: kFontSize42, color: const Color(0xFF333333)),
                          ),
                          Text(
                            "${model.highAmount ?? 0}",
                            style: TextStyle(fontSize: kFontSize96, fontWeight: FontWeight.bold, color: const Color(0xFF333333)),
                          )
                        ],
                      ),
                      Text(
                ...
                Container(
                    ...
                    padding: EdgeInsets.fromLTRB(kSize32, kSize8, kSize32, kSize8),
                    decoration: BoxDecoration(borderRadius: BorderRadius.circular(kSize20), color: const Color(0xFFFFFFFF)),
                    child: Column(
                      children: [
                        const HFQLargeApplyFrom(title: "身份信息：", statusString: "已通过"),
                        Divider(color: Color(0x80CCCCCC), height: kSize2),
                        const HFQLargeApplyFrom(title: "留资信息：", statusString: "已通过"),
                        // Divider(color: Color(0x80CCCCCC), height: kSize2),
                      ...
                      children: [
                        Expanded(
                          ...
                          children: [
                            Text(
                              "匹配贷款平台",
                              style: TextStyle(fontSize: kFontSize28, fontWeight: FontWeight.bold, color: const Color(0xFF3D3D3D)),
                            ),
                            SizedBox(height: kSize8),
                            Text(
                              "综合下款率最高，放款快",
                              style: TextStyle(fontSize: kFontSize24, fontWeight: FontWeight.bold, color: const Color(0xFF888888)),
                            )
                          ],
                        )),
                        Expanded(
                          ...
                          children: [
                            Row(
                              ...
                              children: [
                                networkImage(width: kSize32, height: kSize32, url: model.logo ?? ""),
                                SizedBox(width: kSize16),
                                Text(
                                  model.name ?? "",
                                  style: TextStyle(fontSize: kFontSize28, fontWeight: FontWeight.bold, color: const Color(0xFF3D3D3D)),
